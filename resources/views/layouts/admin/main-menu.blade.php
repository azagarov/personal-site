...
<li @if($selectedMenuItem == 'new-portfolio-item') class="active" @endif><a href="{{url('/admin/portfolio/edit-item/new')}}"><i class="fa fa-pencil"></i> <span>{{__('New Item')}}</span></a></li>
<li @if($selectedMenuItem == 'portfolio-items-list') class="active" @endif><a href="{{url('/admin/portfolio/items')}}"><i class="fa fa-pencil-square-o"></i> <span>{{__('Portfolio Items')}}</span></a></li>
