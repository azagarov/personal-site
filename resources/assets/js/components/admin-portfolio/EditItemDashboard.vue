...
export default {
    ...
    computed: {
        ...
        changed() {
            return !this.$parent.itemId || this.unsaved.main;
        },
        status: {
            get() {
                return this.$parent.$refs.main.item.status;
            },
            set(v) {
                this.$parent.$refs.main.item.status = v;
            }
        }
    },
    ...
    methods: {
        save() {
            this.$parent.$refs.main.save().then(item => {
